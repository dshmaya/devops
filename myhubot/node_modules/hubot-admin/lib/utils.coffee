...
class utils
  ...
  invite_user: (robot, channelId, userId) ->
    robot.logger.info 'invite user to channel'
    _adapter = @adapter
    return _adapter.inviteUser(channelId, userId)
  ...
  archive_channel_id: (robot, channelId) ->
    robot.logger.info 'archiving'
    _adapter = @adapter
    return _adapter.archive(channelId)
